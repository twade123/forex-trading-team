...
PROMPT_PATH = "/tmp/prompt_variants/iter20g.md"
...
OUT_RESULTS = "/tmp/baseline_2026-05-13_results.json"
OUT_LOG = "/tmp/baseline_2026-05-13_replay.log"
PATTERN_CHART_DIR = "/tmp/replay_charts_baseline_2026-05-13"
...
COHORT = [
    ...
    # 2026-05-13 losing trades — all 7 now closed. P&L updated from actual outcomes.
    # 15205 flipped winner_today_open → loser_today (closed -10.9p, not the +10 estimate).
    ...
    ("14992", "EUR_USD", "SELL", "2026-05-13T09:37:06+00:00", -18.1, "loser_today"),
    ("15179", "GBP_JPY", "SELL", "2026-05-13T13:20:15+00:00", -25.7, "loser_today"),
    ("15205", "USD_CHF", "BUY",  "2026-05-13T15:15:55+00:00", -10.9, "loser_today"),
    ("15227", "EUR_AUD", "SELL", "2026-05-13T16:46:03+00:00", -40.7, "loser_today"),
