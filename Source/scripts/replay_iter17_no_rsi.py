...
INDICATOR_BLOCKS_JSON = "/tmp/cohort_indicator_blocks_no_rsi.json"
...
OUT_RESULTS = "/tmp/iter17_no_rsi_results.json"
OUT_LOG = "/tmp/iter17_no_rsi_replay.log"
...
def main():
    ...
    log(f"ITER 17 NO_RSI SUMMARY (19-trade): {correct_count}/{len(COHORT)} correct "
