"""replay_iter20a.py — iter 20a: recalibrated scout-history thresholds.
...
8. **NEW iter 20a**: badge thresholds raised n≥3 → n≥5 to suppress small-sample noise;
   prompt language strengthened so structural reads override scout warnings.

Run:
    cd "<repo_root>/Source"
    source ~/myenv/bin/activate
    python3 scripts/replay_iter20a.py
"""
...
PROMPT_PATH = "/tmp/prompt_variants/iter20a.md"
...
OUT_RESULTS = "/tmp/iter20a_results.json"
OUT_LOG = "/tmp/iter20a_replay.log"
