"""replay_iter20d.py — iter 20d: continuation composite + pattern-conflict veto.
...
PROMPT_PATH = "/tmp/prompt_variants/iter20d.md"
...
OUT_RESULTS = "/tmp/iter20d_results.json"
OUT_LOG = "/tmp/iter20d_replay.log"
