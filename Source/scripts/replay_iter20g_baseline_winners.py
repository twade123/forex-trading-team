...
PROMPT_PATH = "/tmp/prompt_variants/iter20g_baseline.md"
...
OUT_RESULTS = "/tmp/iter20g_baseline_full_results.json"
OUT_LOG = "/tmp/iter20g_baseline_full_replay.log"
PATTERN_CHART_DIR = "/tmp/replay_charts_iter20g_baseline_full"

COHORT = [
    # === BIG-WINNER PRIORITY BLOCK (iter 28 momentum-override test targets) ===
    # These are the trades iter27 downgraded to WATCH; iter28 should upgrade to TRADE_NOW
    ("13310", "AUD_JPY", "SELL", "2026-04-30T09:49:57+00:00",  71.9, "BIG_WIN_71p"),  # iter27=WATCH
    ("15499", "EUR_JPY", "SELL", "2026-05-14T13:37:49+00:00",  36.5, "BIG_WIN_36p"),  # NEW — never tested
    ("13765", "GBP_JPY", "BUY",  "2026-05-08T07:10:15+00:00",  29.3, "BIG_WIN_29p"),  # iter27=WATCH
    ("15205", "USD_CHF", "BUY",  "2026-05-13T15:15:55+00:00",  10.0, "MID_WIN_10p"),  # iter27=WATCH
    ("15647", "USD_JPY", "BUY",  "2026-05-14T17:50:41+00:00",   8.9, "WIN_safety_9p"), # NEW
    # === Regression-check block: representative IDEAL losers iter27 caught ===
    ("13727", "AUD_USD", "SELL", "2026-05-07T21:21:27+00:00", -30.4, "loser"),         # iter27=SKIP IDEAL
    ("13743", "AUD_JPY", "SELL", "2026-05-07T22:04:25+00:00", -26.7, "loser"),         # iter27=SKIP IDEAL
    ("14249", "GBP_JPY", "BUY",  "2026-05-11T17:21:00+00:00", -48.9, "loser_late"),    # iter27=WATCH OK
    ("14992", "EUR_USD", "SELL", "2026-05-13T09:37:06+00:00", -20.0, "loser_today_open"),  # iter27=SKIP IDEAL
    ("15227", "EUR_AUD", "SELL", "2026-05-13T16:46:03+00:00", -25.0, "loser_today_open"),  # iter27=SKIP IDEAL
    # === Rest of 40-trade cohort (duplicates of priority block removed) ===
    # Original iter 20d 19-trade cohort
    ...
    # NEW iter 20f late-entry losers
    ...
    # NEW iter 20g cohort — 2026-05-13
    ...
    # NEW iter 26 — 2026-05-14 + 2026-05-15 losing trades (plus 1 winner safety)
