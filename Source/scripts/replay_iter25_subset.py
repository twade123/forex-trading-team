...
PROMPT_PATH = "/tmp/prompt_variants/iter25.md"
...
OUT_RESULTS = "/tmp/iter25_results.json"
OUT_LOG = "/tmp/iter25_replay.log"
PATTERN_CHART_DIR = "/tmp/replay_charts_iter25_subset"

COHORT = [
    # SUBSET: only the 4 missed losers from iter22/23/24 (still TRADE_NOW after marker rule)
    # Goal: tight-fan gate should flip 3 of 4 to WATCH (14485, 14882, 14906)
    # 14249 stays TRADE_NOW (different pattern — stale re-cross, needs separate rule)
