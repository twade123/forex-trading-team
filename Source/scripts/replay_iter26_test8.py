...
PROMPT_PATH = "/tmp/prompt_variants/iter26.md"
...
OUT_RESULTS = "/tmp/iter26_test8_results.json"
OUT_LOG = "/tmp/iter26_test8_replay.log"
PATTERN_CHART_DIR = "/tmp/replay_charts_iter26_test8"

# 8-loser cohort (2026-05-14 + 2026-05-15) + 1 winner safety check.
# Goal: CYCLE POSITION READ rule should flip the losers to WATCH while
# leaving 16162 alone or downgrading minimally. 16162 actual was +3.5p
# (cut short by exit_marker) — TRADE_NOW or WATCH both acceptable, SKIP=bad.
COHORT = [
    # Yesterday's losers (2026-05-14)
    ("15439", "EUR_GBP", "SELL", "2026-05-14T12:57:36+00:00", -13.5, "loser_y"),
    ("15509", "EUR_JPY", "SELL", "2026-05-14T13:47:39+00:00", -42.2, "loser_y"),
    # Today's losers (2026-05-15)
    ("16104", "EUR_CHF", "SELL", "2026-05-15T08:32:38+00:00",  -3.5, "loser_t"),
    ("16116", "USD_CHF", "BUY",  "2026-05-15T09:53:36+00:00", -17.8, "loser_t"),
    ("16130", "EUR_USD", "SELL", "2026-05-15T12:39:20+00:00",  -9.1, "loser_t"),
    ("16140", "USD_CAD", "BUY",  "2026-05-15T13:40:49+00:00",  -5.1, "loser_t"),
    ("16158", "EUR_USD", "SELL", "2026-05-15T13:56:43+00:00",  -7.6, "loser_t"),
    ("16180", "GBP_JPY", "SELL", "2026-05-15T16:21:26+00:00", -18.9, "loser_t"),
    # Winner safety check (was cut short by exit_marker at +3.5p, true outcome +13.5p MFE)
