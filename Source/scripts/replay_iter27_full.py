...
PROMPT_PATH = "/tmp/prompt_variants/iter27.md"
...
OUT_RESULTS = "/tmp/iter27_full_results.json"
OUT_LOG = "/tmp/iter27_full_replay.log"
PATTERN_CHART_DIR = "/tmp/replay_charts_iter27_full"
...
COHORT = [
    ...
    # NEW iter 20g cohort — 2026-05-13 losing/open trades
    # Goal: ≥5 of 7 downgraded to WATCH or SKIP (15205 USD_CHF buy should be preserved)
    ...
    ("15205", "USD_CHF", "BUY",  "2026-05-13T15:15:55+00:00",  10.0, "winner_today_open"),
