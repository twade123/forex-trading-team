...
PROMPT_PATH = "/tmp/prompt_variants/iter38.md"
...
OUT_RESULTS = "/tmp/iter38_subset_results.json"
OUT_LOG = "/tmp/iter38_subset_replay.log"
PATTERN_CHART_DIR = "/tmp/replay_charts_iter36_full"  # reuse iter36 charts — same cohort trades, only prompt changes

# 12-trade decision-boundary subset for iter37 iteration testing.
# Hypothesis: FRESH MOMENTUM OVERRIDE recovers big-winner WATCHes without adding new BADs.
# Composition:
#   5 big winners stuck at WATCH in iter36 — TARGET for recovery
#   3 winners iter36 already TN'd — must hold
#   1 persistent BAD iter36 TN'd (loser) — expected to stay TN (no improvement, no regression)
#   2 losers iter27 caught (must stay SKIP/WATCH) — regression-check
#   1 regression case iter32→iter36 lost (must recover)
COHORT = [
    # --- TARGET: big winners stuck at WATCH ---
    ("13310", "AUD_JPY", "SELL", "2026-04-30T09:49:57+00:00",  71.9, "BIG_WIN_71p_target"),
    ("15499", "EUR_JPY", "SELL", "2026-05-14T13:37:49+00:00",  36.5, "BIG_WIN_36p_target"),
    ("13765", "GBP_JPY", "BUY",  "2026-05-08T07:10:15+00:00",  29.3, "BIG_WIN_29p_target"),
    ("15205", "USD_CHF", "BUY",  "2026-05-13T15:15:55+00:00",  10.0, "MID_WIN_10p_target"),
    ("15647", "USD_JPY", "BUY",  "2026-05-14T17:50:41+00:00",   8.9, "WIN_safety_9p_target"),
    # --- HOLD: iter36 already TN'd these winners ---
    ("13578", "AUD_USD", "SELL", "2026-05-04T16:51:45+00:00",   3.5, "winner_must_hold_TN"),
    ("13817", "EUR_JPY", "BUY",  "2026-05-08T10:02:34+00:00",   5.1, "winner_must_hold_TN"),
    ("13827", "EUR_USD", "BUY",  "2026-05-08T10:17:53+00:00",   4.7, "winner_must_hold_TN"),
    # --- PERSISTENT BAD (no regression expected) ---
    ("14485", "EUR_AUD", "BUY",  "2026-05-12T08:02:00+00:00", -27.2, "persistent_BAD"),
    # --- LOSERS THAT MUST STAY SKIPPED/WATCHED (regression check) ---
    ("14906", "EUR_JPY", "SELL", "2026-05-13T08:04:41+00:00", -22.7, "loser_must_not_TN"),
    ("15509", "EUR_JPY", "SELL", "2026-05-14T13:47:39+00:00", -42.2, "loser_must_not_TN"),
    # --- ITER32→36 REGRESSION CASE ---
    ("13396", "EUR_CHF", "SELL", "2026-04-30T13:48:54+00:00",  17.9, "winner_iter32_caught"),
]
